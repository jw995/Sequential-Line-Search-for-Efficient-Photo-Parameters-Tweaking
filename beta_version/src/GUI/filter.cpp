...
void Filter::CombinedFilter(int wid,int hei,unsigned char srcRgba[], unsigned char tgtRgbaIn[],double newContrast, double brightness, double saturation, double redLevel, double greenLevel, double blueLevel) {
    float blue, green, red;

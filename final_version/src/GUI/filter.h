...
public:
    ...
    void CombinedFilter(int wid,int hei,unsigned char srcRgba[], unsigned char tgtRgba[],double contrast, double brightness, double saturation, double redLevel, double greenLevel, double blueLevel);
};
#endif